...
while i < len(list):
    if benchmark:
        first = first + list[i+0] + " & " + foo(list[i+1]) + " & " + foo(list[i+2]) + " & " + foo(list[i+3]) + " & " + foo(list[i+4]) + " & " + foo2(list[i+5]) + " & " + foo(list[i+6]) + "\\\\ \n"
        i = i + 7
    else:
        first = first + list[i+0] + " & " + foo(list[i+1]) + " & " + foo(list[i+2]) + " & " + foo(list[i+3]) + " & " + foo(list[i+4]) + " & " + foo2(list[i+5]) + " & " + foo(list[i+6]) + "\\\\ \n"
        second = second + list[i+0] + " & " + foo(list[i+7]) + " & " + foo(list[i+8]) + " & " + foo(list[i+9]) + " & " + foo(list[i+10]) + "\\\\ \n"
        i = i + 11
